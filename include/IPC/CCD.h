...
void initSpatialHash(bool advected, FEMParamters& parameters, 
	Mesh& tetSimMesh, std::vector<Eigen::Vector3d>& direction, 
	double cellSize, std::vector<spatialHashCellData>& spatialHash_vec, 
	std::map<std::string, int>& hashNameIndex, int timestep);
