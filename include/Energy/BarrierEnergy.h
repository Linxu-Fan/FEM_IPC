...
namespace Ground
{
	...
	void gradAndHess(std::vector<Eigen::Triplet<double>>& hessian_triplet, std::vector<std::pair<int, double>>& grad_triplet, int& startIndex_hess, int& startIndex_grad, std::vector<boundaryCondition>& boundaryCondition_node,int index_i, double coor_z, double d_hat, double distributedArea, double k_stiff, double dt);
