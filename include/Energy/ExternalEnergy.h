...
namespace ExternalEnergy
{
	...
	void Grad(std::vector<std::pair<int, double>>& grad_triplet, int& startIndex_grad, double nodeMass, double dt, Eigen::Vector3d& x, FEMParamters& param, Eigen::Vector3d& extForce, int vertIndex, int BC); // BC: boundary condition of the vertex
