...
namespace ExternalEnergy
{
	...
	std::vector<std::pair<int, double>> Grad(double nodeMass, double dt, Eigen::Vector3d& x, FEMParamters& param, Eigen::Vector3d& extForce, int vertIndex, int BC); // BC: boundary condition of the vertex
