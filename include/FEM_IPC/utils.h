...
namespace DIS {
    ...
    inline void d_PP(const Eigen::Vector3d& v0,
    ...
    inline void g_PE(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        Vector9d& g)
    {
    ...
    inline void H_PE(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        Matrix9d& H)
    {
    ...
    inline void d_PT(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
    ...
    inline void g_PT(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        const Eigen::Vector3d& v3,
        Vector12d& g)
    ...
    inline void H_PT(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        const Eigen::Vector3d& v3,
        Matrix12d& H)
    ...
    inline void d_EE(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        const Eigen::Vector3d& v3,
        double& d)
    ...
    inline void g_EE(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        const Eigen::Vector3d& v3,
        Vector12d& g)
    ...
    inline void H_EE(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        const Eigen::Vector3d& v3,
        Matrix12d& H)
    ...
    inline int dType_EE(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        const Eigen::Vector3d& v3)
    {
    ...
    inline int dType_PT(const Eigen::Vector3d& v0_,
        const Eigen::Vector3d& v1_,
        const Eigen::Vector3d& v2_,
        const Eigen::Vector3d& v3_)
    {
        Eigen::RowVector3d v0 = v0_.transpose();
        Eigen::RowVector3d v1 = v1_.transpose();
        Eigen::RowVector3d v2 = v2_.transpose();
        Eigen::RowVector3d v3 = v3_.transpose();
        ...
        const Eigen::Vector3d nVec = basis.row(0).cross(basis.row(1));
    ...
    {
        std::vector<std::vector<Eigen::Vector3d>> testData;
    ...
    inline void computePointEdgeD(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        double& d)
    {
        Eigen::Vector3d v = v2 - v1;
        Eigen::Vector3d w = v0 - v1;
    ...
    inline void computePointTriD(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        const Eigen::Vector3d& v3,
        double& d)
    ...
    inline void computeEdgeEdgeD(const Eigen::Vector3d& v0,
        const Eigen::Vector3d& v1,
        const Eigen::Vector3d& v2,
        const Eigen::Vector3d& v3,
        double& d)
    ...
    {
        Eigen::Vector3d v0, v1, v20, v3t, v2t;
        v0 << 0.0, 0.0, 0.0;
        v1 << 1.0, 0.0, 0.0;
        v20 << -0.1, 1.0, 1.0;
        v3t << 1.0, 0.0, -1.0;
        ...
        Eigen::Vector3d v30 = v20 + 0.01 * (v3t - v20);
        double step = 0.01;
    ...
    inline double cal_EEM_eps_x(Eigen::Vector3d& P1_Rest, Eigen::Vector3d& P2_Rest, Eigen::Vector3d& Q1_Rest, Eigen::Vector3d& Q2_Rest)
    {
        return 1.0e-3 * (P1_Rest - P2_Rest).squaredNorm() * (Q1_Rest - Q2_Rest).squaredNorm();
    }
