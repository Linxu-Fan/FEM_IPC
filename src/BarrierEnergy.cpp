...
void BarrierEnergy_tmp::valGradAndHess_PT(BarrierEnergyRes& BEres, int type, double dis2, Mesh& tetMesh, double d_hat, double k_stiff, double dt)
{
...
void BarrierEnergy::valGradAndHess_PT(BarrierEnergyRes& BEres, int type, double dis2, Mesh& tetMesh, double d_hat, double k_stiff, double dt)
{
    ...
    case 0:
    {
        Vector6d partial_d2is_partial_x = Vector6d::Zero(), grad_ = Vector6d::Zero();
        Matrix6d partial_2d2is_partial_x2 = Matrix6d::Zero(), hess_ = Matrix6d::Zero();
        DIS::g_PP(P, A, partial_d2is_partial_x); // 2
        DIS::H_PP(partial_2d2is_partial_x2); // 4

        grad_ = dt * dt * k_stiff * contactArea * partial_d2is_partial_x * partial_b_partial_d2is;
        hess_ = dt * dt * k_stiff * contactArea * (partial_2b_partial_d2is2 * partial_d2is_partial_x * partial_d2is_partial_x.transpose() + partial_b_partial_d2is * partial_2d2is_partial_x2);
        Eigen::Vector2i activePtsLocalInd = { 0 , 1 };
        store_grad_hess_PT(BEres, grad_, hess_, activePtsLocalInd);
    }
    break;
    case 1:
    {
        Vector6d partial_d2is_partial_x = Vector6d::Zero(), grad_ = Vector6d::Zero();
        Matrix6d partial_2d2is_partial_x2 = Matrix6d::Zero(), hess_ = Matrix6d::Zero();
        DIS::g_PP(P, B, partial_d2is_partial_x); // 2
        DIS::H_PP(partial_2d2is_partial_x2); // 4
    ...
    case 2:
    {
        Vector6d partial_d2is_partial_x = Vector6d::Zero(), grad_ = Vector6d::Zero();
        Matrix6d partial_2d2is_partial_x2 = Matrix6d::Zero(), hess_ = Matrix6d::Zero();
        DIS::g_PP(P, C, partial_d2is_partial_x); // 2
        DIS::H_PP(partial_2d2is_partial_x2); // 4
    ...
    case 3:
    {
        Vector9d partial_d2is_partial_x = Vector9d::Zero(), grad_ = Vector9d::Zero();
        Matrix9d partial_2d2is_partial_x2 = Matrix9d::Zero(), hess_ = Matrix9d::Zero();
        DIS::g_PE(P, A, B, partial_d2is_partial_x); // 2
        DIS::H_PE(P, A, B, partial_2d2is_partial_x2); // 4
    ...
    case 4:
    {
        Vector9d partial_d2is_partial_x = Vector9d::Zero(), grad_ = Vector9d::Zero();
        Matrix9d partial_2d2is_partial_x2 = Matrix9d::Zero(), hess_ = Matrix9d::Zero();
        DIS::g_PE(P, B, C, partial_d2is_partial_x); // 2
        DIS::H_PE(P, B, C, partial_2d2is_partial_x2); // 4
    ...
    case 5:
    {
        Vector9d partial_d2is_partial_x = Vector9d::Zero(), grad_ = Vector9d::Zero();
        Matrix9d partial_2d2is_partial_x2 = Matrix9d::Zero(), hess_ = Matrix9d::Zero();
        DIS::g_PE(P, C, A, partial_d2is_partial_x); // 2
        DIS::H_PE(P, C, A, partial_2d2is_partial_x2); // 4
    ...
    case 6:
    {
        Vector12d partial_d2is_partial_x = Vector12d::Zero(), grad_ = Vector12d::Zero();
        Matrix12d partial_2d2is_partial_x2 = Matrix12d::Zero(), hess_ = Matrix12d::Zero();
        DIS::g_PT(P, A, B, C, partial_d2is_partial_x); // 2
        DIS::H_PT(P, A, B, C, partial_2d2is_partial_x2); // 4
...
// compute the energy gradient and hessian 
void BarrierEnergy_tmp::valGradAndHess_EE(BarrierEnergyRes& BEres, int type, double dis2, Mesh& tetMesh, double d_hat, double k_stiff, double dt)
{
...
void BarrierEnergy::valGradAndHess_EE(BarrierEnergyRes& BEres, int type, double dis2, Mesh& tetMesh, double d_hat, double k_stiff, double dt)
{
    ...
    case 0:
    {
        Vector6d partial_d2is_partial_x = Vector6d::Zero(), grad_ = Vector6d::Zero();
        Matrix6d partial_2d2is_partial_x2 = Matrix6d::Zero(), hess_ = Matrix6d::Zero();
        DIS::g_PP(P1Coor, Q1Coor, partial_d2is_partial_x); // 2
        DIS::H_PP(partial_2d2is_partial_x2); // 4
    ...
    case 1:
    {
        Vector6d partial_d2is_partial_x = Vector6d::Zero(), grad_ = Vector6d::Zero();
        Matrix6d partial_2d2is_partial_x2 = Matrix6d::Zero(), hess_ = Matrix6d::Zero();
        DIS::g_PP(P1Coor, Q2Coor, partial_d2is_partial_x); // 2
        DIS::H_PP(partial_2d2is_partial_x2); // 4
    ...
    case 2:
    {
        Vector9d partial_d2is_partial_x = Vector9d::Zero(), grad_ = Vector9d::Zero();
        Matrix9d partial_2d2is_partial_x2 = Matrix9d::Zero(), hess_ = Matrix9d::Zero();
        DIS::g_PE(P1Coor, Q1Coor, Q2Coor, partial_d2is_partial_x); // 2
        DIS::H_PE(P1Coor, Q1Coor, Q2Coor, partial_2d2is_partial_x2); // 4
    ...
    case 3:
    {
        Vector6d partial_d2is_partial_x = Vector6d::Zero(), grad_ = Vector6d::Zero();
        Matrix6d partial_2d2is_partial_x2 = Matrix6d::Zero(), hess_ = Matrix6d::Zero();
        DIS::g_PP(P2Coor, Q1Coor, partial_d2is_partial_x); // 2
        DIS::H_PP(partial_2d2is_partial_x2); // 4
    ...
    case 4:
    {
        Vector6d partial_d2is_partial_x = Vector6d::Zero(), grad_ = Vector6d::Zero();
        Matrix6d partial_2d2is_partial_x2 = Matrix6d::Zero(), hess_ = Matrix6d::Zero();
        DIS::g_PP(P2Coor, Q2Coor, partial_d2is_partial_x); // 2
        DIS::H_PP(partial_2d2is_partial_x2); // 4
    ...
    case 5:
    {
        Vector9d partial_d2is_partial_x = Vector9d::Zero(), grad_ = Vector9d::Zero();
        Matrix9d partial_2d2is_partial_x2 = Matrix9d::Zero(), hess_ = Matrix9d::Zero();
        DIS::g_PE(P2Coor, Q1Coor, Q2Coor, partial_d2is_partial_x); // 2
        DIS::H_PE(P2Coor, Q1Coor, Q2Coor, partial_2d2is_partial_x2); // 4
    ...
    case 6:
    {
        Vector9d partial_d2is_partial_x = Vector9d::Zero(), grad_ = Vector9d::Zero();
        Matrix9d partial_2d2is_partial_x2 = Matrix9d::Zero(), hess_ = Matrix9d::Zero();
        DIS::g_PE(Q1Coor, P1Coor, P2Coor, partial_d2is_partial_x); // 2
        DIS::H_PE(Q1Coor, P1Coor, P2Coor, partial_2d2is_partial_x2); // 4
    ...
    case 7:
    {
        Vector9d partial_d2is_partial_x = Vector9d::Zero(), grad_ = Vector9d::Zero();
        Matrix9d partial_2d2is_partial_x2 = Matrix9d::Zero(), hess_ = Matrix9d::Zero();
        DIS::g_PE(Q2Coor, P1Coor, P2Coor, partial_d2is_partial_x); // 2
        DIS::H_PE(Q2Coor, P1Coor, P2Coor, partial_2d2is_partial_x2); // 4
    ...
    case 8:
    {
        Vector12d partial_d2is_partial_x = Vector12d::Zero(), grad_ = Vector12d::Zero();
        Matrix12d partial_2d2is_partial_x2 = Matrix12d::Zero(), hess_ = Matrix12d::Zero();
        DIS::g_EE(P1Coor, P2Coor, Q1Coor, Q2Coor, partial_d2is_partial_x); // 2
        DIS::H_EE(P1Coor, P2Coor, Q1Coor, Q2Coor, partial_2d2is_partial_x2); // 4
...
void BarrierEnergy_tmp::store_grad_hess_PT(BarrierEnergyRes& BEres, Vector6d& grad_, Matrix6d& hess_, Eigen::Vector2i& activePtsLocalInd)
{
...
// store gradient and hessian value
void BarrierEnergy_tmp::store_grad_hess_PT(BarrierEnergyRes& BEres, Vector9d& grad_, Matrix9d& hess_, Eigen::Vector3i& activePtsLocalInd)
{
    for (int m = 0; m < activePtsLocalInd.size(); m++)
    {
        int index_m = activePtsLocalInd[m];
...
// store gradient and hessian value
void BarrierEnergy_tmp::store_grad_hess_PT(BarrierEnergyRes& BEres, Vector12d& grad_, Matrix12d& hess_, Eigen::Vector4i& activePtsLocalInd)
{
    for (int m = 0; m < activePtsLocalInd.size(); m++)
    {
        int index_m = activePtsLocalInd[m];
...
void BarrierEnergy_tmp::store_grad_hess_EE(BarrierEnergyRes& BEres, Vector12d& grad_final, Matrix12d& hess_final)
{
    for (int m = 0; m < 4; m++)
    {
...
void BarrierEnergy_tmp::project_grad_to_full(Eigen::Vector2i& activePtsLocalInd, Vector6d& grad_, Matrix6d& hess_, Vector12d& grad_full, Matrix12d& hess__full)
{
    for (int i = 0; i < 2; i++)
    {
...
void BarrierEnergy_tmp::project_grad_to_full(Eigen::Vector3i& activePtsLocalInd, Vector9d& grad_, Matrix9d& hess_, Vector12d& grad_full, Matrix12d& hess__full)
{
    for (int i = 0; i < 3; i++)
    {
        int index_i = activePtsLocalInd[i];
