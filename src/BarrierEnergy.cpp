...
std::vector<std::pair<int, double>> BarrierEnergy::Grad(bool pointTriangle, int type, double dis2, Mesh& tetMesh, Eigen::Vector4i vtInd, Eigen::Vector4i vtInd_BC, double d_hat, double k_stiff, double dt)
{
    ...
    if (pointTriangle)
    {
        ...
        case 0:
        {
            ...
            Vector6d grad_ = dt * dt * k_stiff * contactArea * pointPointDis2_grad(P, A) * partial_b_partial_d;
        ...
        case 1:
        {
            ...
            Vector6d grad_ = dt * dt * k_stiff * contactArea * pointPointDis2_grad(P, B) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 2:
        {
            ...
            Vector6d grad_ = dt * dt * k_stiff * contactArea * pointPointDis2_grad(P, C) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 3:
        {
            ...
            Vector9d grad_ = dt * dt * k_stiff * contactArea * pointEdgeDis2_grad(P, A, B) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 4:
        {
            ...
            Vector9d grad_ = dt * dt * k_stiff * contactArea * pointEdgeDis2_grad(P, B, C) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 5:
        {
            ...
            Vector9d grad_ = dt * dt * k_stiff * contactArea * pointEdgeDis2_grad(P, C, A) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 6:
        {
            ...
            Vector12d grad_ = dt * dt * k_stiff * contactArea * pointTriangleInsideDis2_grad(P, A, B, C) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
    ...
    else
    {
        ...
        case 0:
        {
            ...
            Vector6d grad_ = dt * dt * k_stiff * contactArea * pointPointDis2_grad(P1Coor, Q1Coor) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 1:
        {
            ...
            Vector9d grad_ = dt * dt * k_stiff * contactArea * pointEdgeDis2_grad(P1Coor, Q1Coor, Q2Coor) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 2:
        {
            ...
            Vector6d grad_ = dt * dt * k_stiff * contactArea * pointPointDis2_grad(P1Coor, Q2Coor) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 3:
        {
            ...
            Vector9d grad_ = dt * dt * k_stiff * contactArea * pointEdgeDis2_grad(Q1Coor, P1Coor, P2Coor) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 4:
        {
            ...
            Vector12d grad_ = dt * dt * k_stiff * contactArea * edgeEdgeInsideDis2_grad(P1Coor, P2Coor, Q1Coor, Q2Coor) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 5:
        {
            ...
            Vector9d grad_ = dt * dt * k_stiff * contactArea * pointEdgeDis2_grad(Q2Coor, P1Coor, P2Coor) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 6:
        {
            ...
            Vector6d grad_ = dt * dt * k_stiff * contactArea * pointPointDis2_grad(P2Coor, Q1Coor) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 7:
        {
            ...
            Vector9d grad_ = dt * dt * k_stiff * contactArea * pointEdgeDis2_grad(P2Coor, Q1Coor, Q2Coor) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
        ...
        case 8:
        {
            ...
            Vector6d grad_ = dt * dt * k_stiff * contactArea * pointPointDis2_grad(P2Coor, Q2Coor) * partial_b_partial_d;
            for (int m = 0; m < activePts.size(); m++)
            {
                if (activePtsBC[m] != 1)
                {
