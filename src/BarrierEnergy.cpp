...
double BarrierEnergy::val_PT(double contactArea, double dis2, double d_hat, double k_stiff, double dt)
{
    ...
    return dt * dt * k_stiff * contactArea * bEnergy;
}
...
void BarrierEnergy::gradAndHess_PT(BarrierEnergyRes& GH, Eigen::Vector4i& ptIndices, int type, double dis2, Mesh& tetMesh, double d_hat, double k_stiff, double dt)
{
    ...
    case 0:
    {
        ...
        GH.H6x6.push_back(dt * dt * k_stiff * contactArea * (partial_2b_partial_dis2 * partial_dis_partial_x * partial_dis_partial_x.transpose() + partial_b_partial_dis * partial_2dis_partial_x2));
    ...
    case 3:
    {
        ...
        GH.H9x9.push_back(dt * dt * k_stiff * contactArea * (partial_2b_partial_dis2 * partial_dis_partial_x * partial_dis_partial_x.transpose() + partial_b_partial_dis * partial_2dis_partial_x2));
    ...
    case 6:
    {
        ...
        GH.H12x12.push_back(dt * dt * k_stiff * contactArea * (partial_2b_partial_dis2 * partial_dis_partial_x * partial_dis_partial_x.transpose() + partial_b_partial_dis * partial_2dis_partial_x2));
...
void BarrierEnergy::gradAndHess_EE(BarrierEnergyRes& GH, Eigen::Vector4i& ptIndices, int type, double dis2, Mesh& tetMesh, double d_hat, double k_stiff, double dt)
{
    ...
    case 0:
    {
        ...
        GH.V12.push_back(grad_ek * val_b + val_ek * grad_b);
        GH.H12x12.push_back(hess_ek * val_b + grad_ek * grad_b.transpose() + grad_b * grad_ek.transpose() + val_ek * hess_b);
    ...
    case 8:
    {
        ...
        // now calcualte the final val, grad and hess considering the mollifier
        GH.V12.push_back(grad_ek * val_b + val_ek * grad_);
        GH.H12x12.push_back(hess_ek * val_b + grad_ek * grad_.transpose() + grad_ * grad_ek.transpose() + val_ek * hess_);
        GH.D4Index.push_back(ptIndices);
    }
    break;
