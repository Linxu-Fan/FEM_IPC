...
double pointTriangleDis2(Eigen::Vector3d P, Eigen::Vector3d A, Eigen::Vector3d B, Eigen::Vector3d C)
{
    ...
    {
    case 0:
        return pointPointDis2_val( P, A);
    case 1:
        return pointPointDis2_val(P, B);
    case 2:
        return pointPointDis2_val(P, C);
    case 3:
        return pointEdgeDis2_val(P, A, B);
    case 4:
        return pointEdgeDis2_val(P, B, C);
    case 5:
        return pointEdgeDis2_val(P, C, A);
    case 6:
        return pointTriangleInsideDis2_val(P, A, B, C);
    default:
        return pointTriangleInsideDis2_val(P, A, B, C);
    }
...
double edgeEdgeDis2(int type, Eigen::Vector3d P1, Eigen::Vector3d P2, Eigen::Vector3d Q1, Eigen::Vector3d Q2)
{
    ...
    {
    case 0:
        return pointPointDis2_val(P1, Q1);
    case 1:
        return pointEdgeDis2_val(P1, Q1, Q2);
    case 2:
        return pointPointDis2_val(P1, Q2);
    case 3:
        return pointEdgeDis2_val(Q1, P1, P2);
    case 4:
        return edgeEdgeInsideDis2_val(P1, P2, Q1, Q2);
    case 5:
        return pointEdgeDis2_val(Q2, P1, P2);
    case 6:
        return pointPointDis2_val(P2, Q1);
    case 7:
        return pointEdgeDis2_val(P2, Q1, Q2);
    case 8:
        return pointPointDis2_val(P2, Q2);
    default:
        return edgeEdgeInsideDis2_val(P1, P2, Q1, Q2);
    }
}
...
{
    Eigen::Vector3d tmp = A - B;
    double val = tmp.squaredNorm();   
    return val;
}
...
Vector6d pointPointDis2_grad(Eigen::Vector3d A, Eigen::Vector3d B)
{
    Eigen::Vector3d tmp = A - B;
    double val = tmp.squaredNorm();
    Vector6d grad = { 2.0 * tmp[0] , 2.0 * tmp[1] , 2.0 * tmp[2] , -2.0 * tmp[0] , -2.0 * tmp[1] , -2.0 * tmp[2] };
    return grad;
}
...
double pointEdgeDis2_val(Eigen::Vector3d P, Eigen::Vector3d A, Eigen::Vector3d B)
{
    Eigen::Vector3d AP = P - A;
    Eigen::Vector3d AB = B - A;
    double proj = AP.dot(AB.normalized());
    double val = AP.dot(AP) - proj * proj;
    return val;
}
...
Vector9d pointEdgeDis2_grad(Eigen::Vector3d P, Eigen::Vector3d A, Eigen::Vector3d B)
{
    ...
    double v01 = P[0], v02 = P[1], v03 = P[2], v11 = A[0], v12 = A[1], v13 = A[2], v21 = B[0], v22 = B[1], v23 = B[2];
    {
        ...
        grad[0] = t42 * (t24 * t44 * 2.0 + t25 * t45 * 2.0);
        grad[1] = -t42 * (t23 * t44 * 2.0 - t25 * t46 * 2.0);
        grad[2] = -t42 * (t23 * t45 * 2.0 + t24 * t46 * 2.0);
        grad[3] = -t51 - t42 * (t21 * t44 * 2.0 + t22 * t45 * 2.0);
        grad[4] = -t52 + t42 * (t20 * t44 * 2.0 - t22 * t46 * 2.0);
        grad[5] = -t43 + t42 * (t20 * t45 * 2.0 + t21 * t46 * 2.0);
        grad[6] = t51 + t42 * (t18 * t44 * 2.0 + t19 * t45 * 2.0);
        grad[7] = t52 - t42 * (t17 * t44 * 2.0 - t19 * t46 * 2.0);
        grad[8] = t43 - t42 * (t17 * t45 * 2.0 + t18 * t46 * 2.0);
    }
    return grad;
}
...
{
    Vector12d grad;
    double v01 = P[0], v02 = P[1], v03 = P[2], v11 = A[0], v12 = A[1], v13 = A[2], v21 = B[0], v22 = B[1], v23 = B[2], v31 = C[0], v32 = C[1], v33 = C[2];
    {
        double t11;
        double t12;
        double t13;
        ...
        t44 = t43 * t43;
        t46 = t45 * t45;
        grad[0] = t34 * t43 * t45 * 2.0;
        grad[1] = t33 * t43 * t45 * -2.0;
        grad[2] = t32 * t43 * t45 * 2.0;
        t45 *= t43;
        grad[3] = -t44 * t46 * (t21 * t32 * 2.0 + t22 * t33 * 2.0) - t45 * ((t34 + t12 * t22) - t13 * t21) * 2.0;
        t43 = t44 * t46;
        grad[4] = t43 * (t20 * t32 * 2.0 - t22 * t34 * 2.0) + t45 * ((t33 + t11 * t22) - t13 * t20) * 2.0;
        grad[5] = t43 * (t20 * t33 * 2.0 + t21 * t34 * 2.0) - t45 * ((t32 + t11 * t21) - t12 * t20) * 2.0;
        grad[6] = t45 * (t12 * t19 - t13 * t18) * 2.0 + t43 * (t18 * t32 * 2.0 + t19 * t33 * 2.0);
        grad[7] = t45 * (t11 * t19 - t13 * t17) * -2.0 - t43 * (t17 * t32 * 2.0 - t19 * t34 * 2.0);
        grad[8] = t45 * (t11 * t18 - t12 * t17) * 2.0 - t43 * (t17 * t33 * 2.0 + t18 * t34 * 2.0);
        grad[9] = t45 * (t12 * t16 - t13 * t15) * -2.0 - t43 * (t15 * t32 * 2.0 + t16 * t33 * 2.0);
        grad[10] = t45 * (t11 * t16 - t13 * t14) * 2.0 + t43 * (t14 * t32 * 2.0 - t16 * t34 * 2.0);
        grad[11] = t45 * (t11 * t15 - t12 * t14) * -2.0 + t43 * (t14 * t33 * 2.0 + t15 * t34 * 2.0);
    }
    return grad;
}
...
// calculate the distance between two edges (only when two cloest points are inside)
double edgeEdgeInsideDis2_val(Eigen::Vector3d P1, Eigen::Vector3d P2, Eigen::Vector3d Q1, Eigen::Vector3d Q2)
{
    Eigen::Vector3d b = ((P2 - P1).cross(Q2 - Q1)).normalized();
    double aTb = (P1 - Q1).dot(b);
    double val = aTb * aTb;
    return val;
}
...
{
    Vector12d grad;
    double v01 = P1[0], v02 = P1[1], v03 = P1[2], v11 = P2[0], v12 = P2[1], v13 = P2[2], v21 = Q1[0], v22 = Q1[1], v23 = Q1[2], v31 = Q2[0], v32 = Q2[1], v33 = Q2[2];
    {
        double t11;
        double t12;
        double t13;
        ...
        t76 = t75 * t77;
        grad[0] = -t81 + t76 * ((-t36 + t37) + t46) * 2.0;
        grad[1] = t19 - t76 * ((-t34 + t35) + t45) * 2.0;
        grad[2] = t18 + t76 * ((-t32 + t33) + t44) * 2.0;
        grad[3] = t81 + t76 * (t36 - t37) * 2.0;
        grad[4] = -t19 - t76 * (t34 - t35) * 2.0;
        grad[5] = -t18 + t76 * (t32 - t33) * 2.0;
        t17 = t12 * t16 + -(t13 * t15);
        grad[6] = t79 - t76 * (t17 + t46) * 2.0;
        t18 = t11 * t16 + -(t13 * t14);
        grad[7] = -t83 + t76 * (t18 + t45) * 2.0;
        t19 = t11 * t15 + -(t12 * t14);
        grad[8] = -t80 - t76 * (t19 + t44) * 2.0;
        grad[9] = -t79 + t76 * t17 * 2.0;
        grad[10] = t83 - t76 * t18 * 2.0;
        grad[11] = t80 + t76 * t19 * 2.0;
    }
    return grad;
}
...
double cal_EEM_ek_wrt_c(double eps_x, double c)
{
    if (c < eps_x) 
    {
        ...
        return 2 * one_div_eps_x * (-one_div_eps_x * c + 1);
    }
    else 
    {
        return 0;
...
Vector12d cal_EEM_c_wrt_x(Eigen::Vector3d& P1, Eigen::Vector3d& P2, Eigen::Vector3d& Q1, Eigen::Vector3d& Q2)
{
    ...
    double v01 = P1[0], v02 = P1[1], v03 = P1[2], v11 = P2[0], v12 = P2[1], v13 = P2[2];
    double v21 = Q1[0], v22 = Q1[1], v23 = Q1[2], v31 = Q2[0], v32 = Q2[1], v33 = Q2[2];
