...
void DIS::d_PP(const Eigen::Vector3d& v0,
...
void DIS::g_PP(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    Vector6d& g)
{
...
void DIS::d_PE(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
...
void DIS::g_PE(double v01, double v02, double v03, double v11, double v12, double v13,
...
void DIS::g_PE(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    Vector9d& g)
{
...
void DIS::H_PE(double v01, double v02, double v03, double v11, double v12, double v13,
...
void DIS::H_PE(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    Matrix9d& H)
{
...
void DIS::d_PT(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
...
void DIS::g_PT(double v01, double v02, double v03, double v11, double v12, double v13,
...
void DIS::g_PT(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    const Eigen::Vector3d& v3,
    Vector12d& g)
...
void DIS::H_PT(double v01, double v02, double v03, double v11, double v12, double v13,
    double v21, double v22, double v23, double v31, double v32, double v33,
    double H[144])
{
    double t11;
...
void DIS::H_PT(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    const Eigen::Vector3d& v3,
    Matrix12d& H)
...
void DIS::d_EE(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    const Eigen::Vector3d& v3,
    double& d)
...
void DIS::g_EE(double v01, double v02, double v03, double v11, double v12, double v13,
    double v21, double v22, double v23, double v31, double v32, double v33,
    double g[12])
{
    double t11;
...
void DIS::g_EE(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    const Eigen::Vector3d& v3,
    Vector12d& g)
...
void DIS::H_EE(double v01, double v02, double v03, double v11, double v12, double v13,
    double v21, double v22, double v23, double v31, double v32, double v33,
    double H[144])
{
    double t11;
...
void DIS::H_EE(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    const Eigen::Vector3d& v3,
    Matrix12d& H)
...
int DIS::dType_EE(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    const Eigen::Vector3d& v3)
{
...
int DIS::dType_PT(const Eigen::Vector3d& v0_,
...
void DIS::computePointEdgeD(const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    double& d)
{
...
// cal_EEM_c_wrt_x
void DIS::computeEECrossSqNormGradient(double v01, double v02, double v03, double v11,
...
void DIS::computeEECrossSqNormGradient(
    const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    const Eigen::Vector3d& v3,
...
// cal_EEM_2c_wrt_x2
void DIS::computeEECrossSqNormHessian(double v01, double v02, double v03, double v11,
...
void DIS::computeEECrossSqNormHessian(
    const Eigen::Vector3d& v0,
    const Eigen::Vector3d& v1,
    const Eigen::Vector3d& v2,
    const Eigen::Vector3d& v3,
...
void DIS::derivTest_EECross(void)
{
    Eigen::Vector3d v[4];
    v[0] << 0.0, 0.0, 0.0;
    v[1] << 1.0, 0.1, 0.0;
...
void DIS::compute_q(double input, double eps_x, double& e)
{
    double input_div_eps_x = input / eps_x;
    e = (-input_div_eps_x + 2.0) * input_div_eps_x;
}

void DIS::compute_q_g(double input, double eps_x, double& g)
{
    double one_div_eps_x = 1.0 / eps_x;
    g = 2.0 * one_div_eps_x * (-one_div_eps_x * input + 1.0);
}

void DIS::compute_q_H(double input, double eps_x, double& H)
{
    H = -2.0 / (eps_x * eps_x);
}
...
void DIS::derivTest_e(double eps_x)
{
    Eigen::Vector3d v[4];
    v[0] << 0.0, 0.0, 0.0;
    v[1] << 1.0, 0.1, 0.0;
...
double DIS::cal_EEM_eps_x(Eigen::Vector3d& P1_Rest, Eigen::Vector3d& P2_Rest, Eigen::Vector3d& Q1_Rest, Eigen::Vector3d& Q2_Rest)
{
...
double DIS::cal_EEM_c(Eigen::Vector3d& P1, Eigen::Vector3d& P2, Eigen::Vector3d& Q1, Eigen::Vector3d& Q2)
{
    return (P2 - P1).cross(Q2 - Q1).squaredNorm();
}

// calculate the mollifier value wrt c
double DIS::cal_EEM_ek_wrt_c(double eps_x, double c)
{
    if (c < eps_x)
    {
...
double DIS::cal_EEM_2ek_wrt_c2(double eps_x, double c)
{
    if (c < eps_x)
    {
...
Vector12d DIS::cal_EEM_c_wrt_x(Eigen::Vector3d& P1, Eigen::Vector3d& P2, Eigen::Vector3d& Q1, Eigen::Vector3d& Q2)
{
    Vector12d g;
...
Matrix12d DIS::cal_EEM_2c_wrt_x2(Eigen::Vector3d& P1, Eigen::Vector3d& P2, Eigen::Vector3d& Q1, Eigen::Vector3d& Q2)
{
    double H[144];
